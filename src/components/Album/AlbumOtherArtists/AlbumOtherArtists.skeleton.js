...
import {  PlayListDisplayMobile,  CardContentStyle,CardStyle} from "./AlbumOtherArtists.style";
import PlayListDisplay from "./AlbumOtherArtists.style";

const AlbumOtherArtists = () => {
  const options = [];
  ...
  return (
    <Grid item xs>
       <h2><Skeleton variant="text" sx={{ width: "10rem" }} /></h2>
      <Grid
        style={
...
export default AlbumOtherArtists;
